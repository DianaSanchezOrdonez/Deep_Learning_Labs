...
nombre_modelo = "best_model_resnet50_flush.pth"  # Nombre del modelo guardado
nombre_imagen = "training_history_resnet50.png"
historial_entrenamiento = "training_history_resnet50.json"  # Archivo para guardar el historial de entrenamiento
...
print("📊 Gráfico guardado como 'training_history_resnet50.png'", flush=True)