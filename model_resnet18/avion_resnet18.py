...
nombre_modelo = "best_model_resnet18_flush.pth"  # Nombre del modelo guardado
nombre_imagen = "training_history_resnet18.png"
historial_entrenamiento = "training_history_resnet18.json"  # Archivo para guardar el historial de entrenamiento
...
print("📊 Gráfico guardado como 'training_history_resnet18.png'", flush=True)