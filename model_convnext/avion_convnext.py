...
nombre_modelo = "best_model_convnext_base_flush.pth"  # Nombre del modelo guardado
nombre_imagen = "training_history_convnext.png"
historial_entrenamiento = "training_history_convnext.json"  # Archivo para guardar el historial de entrenamiento
...
state_dict = torch.load("convnext_base-6075fbad.pth", map_location=device) # wget https://download.pytorch.org/models/convnext_base-6075fbad.pth
...
model.classifier[2] = nn.Linear(in_features, 100)  # 100 clases
...
if freeze_backbone:
    optimizer = Adam(model.classifier[2].parameters(), lr=1e-3, weight_decay=1e-4)
...
print("📊 Gráfico guardado como 'training_history_convnext.png'", flush=True)